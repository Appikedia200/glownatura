        ...
        <div className="flex items-center justify-between h-28 py-8">
          ...
          <div className="hidden lg:flex flex-1 max-w-[320px] items-center">
            <div className="relative w-full">
              <MagnifyingGlassIcon className="absolute left-2 top-1/2 transform -translate-y-1/2 h-6 w-6 text-gray-900 stroke-2" />
              <input
                type="text"
                placeholder="Type to search..."
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full pl-10 pr-3 py-2.5 border-0 border-b border-gray-600 bg-transparent focus:outline-none focus:border-black focus:ring-0 text-sm placeholder-gray-400 font-light"
              />
            </div>
          </div>
          ...
          {/* Icons - Right */}
          <div className="flex items-center space-x-6 flex-1 lg:flex-none justify-end">
            
            {/* Mobile Search Icon */}
            <button className="lg:hidden p-2 text-gray-900 hover:text-gray-700 transition-colors">
            ...
            <a href="/maintenance" className="relative p-2 text-gray-900 hover:text-gray-700 transition-colors">
              <HeartIcon className="h-7 w-7 stroke-2" />
              {wishlistCount > 0 && (
            ...
            <a href="/maintenance" className="relative p-2 text-gray-900 hover:text-gray-700 transition-colors group">
              <ShoppingCartIcon className="h-7 w-7 stroke-2" />
