...
export default function FaceSubcategoryClient({ subcategory }: { subcategory: string }) {
  ...
  const currentSubcategory = categories.flatMap(cat => cat.children || []).find(c => c.slug === subcategory)
        ...
        <section className="relative h-[200px] md:h-[240px] overflow-hidden bg-gradient-to-br from-yellow-300 via-yellow-400 to-yellow-500">
          ...
          <div className="relative z-10 h-full flex items-center">
            <div className="max-w-7xl mx-auto px-6 md:px-12 w-full">
              <nav className="mb-2 text-sm text-gray-800 font-libre">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-black font-playfair">
                {subcategoryTitle}
              </h1>
            </div>
          </div>
